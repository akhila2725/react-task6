...
import './App.css';
import abhiImage from "./akhila.jpg"; 
...
function App() {
  ...
  return (
    <div className="App">
      <header>
        <div className="user">
          <img src={abhiImage} alt="Ragiri Akhila" />
          <h3 className="name">Ragiri Akhila</h3>
        </div>
      ...
      <section className="home" id="home">
        <h3>HELLO!!</h3>
        <h1>This is <span>Ragiri Akhila</span></h1>
      </section>
      ...
      <section className="about" id="about">
        ...
        <div className="row">
          <div className="info">
            <h3> <span> Name : </span>Ragiri Akhila </h3>
            <h3> <span> Qualification : </span> B.Tech(pursuing) </h3>
            <h3> <span> Address:</span> palnadu</h3>
      ...
      <section className="education" id="education">
        ...
        <div className="box-container">
          <div className="box">
            ...
            <span>2018-2019</span>
            <h3>SSC</h3>
            <p style={{ fontSize: '20px' }}>sri chaitanya High School,Macherla</p>
          </div>
          <div className="box">
            <i className="fas fa-graduation-cap"></i>
            <span>2019-2021</span>
      ...
      <section className="contact" id="contact">
        ...
        <div className="row">
          <div className="content">
            ...
            <div className="info">
              <h3> <i className="fas fa-envelope"></i> ragiriakhila2004@gmail.com</h3>
              <h3> <i className="fas fa-phone"></i> 7901698687 </h3>
              <h3> <i className="fas fa-map-marker-alt"></i> macherla </h3>
            </div>
          </div>
        </div>
      </section>
